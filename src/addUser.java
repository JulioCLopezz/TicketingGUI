...
public class addUser extends JFrame implements ActionListener{
	...
	public addUser(){
		...
		//Fields to input new user's data
	...
	public void addingUser (){
		...
		//Inserting info to Ticketing DB and create the new user
		try{
	...
	public void actionPerformed(ActionEvent e) {
		...
		//ActionCommand to add the new user to DB
		...
		//JComboBox to add role of the user
		...
		//Action commands to logout and go back to main ware frame
